...
b2.addEventListener("click", function(){
    t2.style.color=colorList[++count];
    if(count==4) count=-1;
})
...
// 클릭된 요소의 테두리를 3px실선 pink로 변경(화살표, e 사용x, this 사용)
button6.addEventListener("click", ()=>{
    console.log(this);
    // 화살표 함수에 this를 작성하면 이벤트가 발생한 요소가 아닌 창 자체를 나타내는 window 객체가 반환된다.
