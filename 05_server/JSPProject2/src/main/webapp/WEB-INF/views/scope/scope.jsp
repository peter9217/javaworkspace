...
<body>
    ...
    <pre>
        Servlet/JSP에는 4종류의 범위를 갖는 내장객체가 존재
        ...
        4. application : 하나의 웹 애플리케이션마다 1개씩 생성되는 객체 서버 켜질 때 생성되어 종료될 때 없어짐
    ...
    방법 2) \${속성명}
        -> 각 범위에 세팅된 속성 중 속성명이 일치하는 경우 우선순위ㅏ 높은 scope의 속성 값이 얻어와짐
