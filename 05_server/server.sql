...
CREATE USER project IDENTIFIED BY "projext1234";
...
INSERT INTO "MEMBER" 
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user01@kh.or.kr', 'pass02!', '유저DL', '01012341234', '04540,,서울시 중구 남대문로 120,,3층', NULL, DEFAULT, DEFAULT, DEFAULT, NULL);

COMMIT;

SELECT MEMBER_NO, MEMBER_EMAIL ,MEMBER_NICKNAME,
MEMBER_TEL, MEMBER_ADDR, PROFILE_IMG, AUTHORITY,
TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" DD"일"') AS ENROLL_DATE FROM "MEMBER" WHERE MEMBER_DEL_FL='N' AND MEMBER_EMAIL ='user01@kh.or.kr' AND MEMBER_PW = 'pass01!';