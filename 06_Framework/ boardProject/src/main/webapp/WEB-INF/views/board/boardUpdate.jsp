...
<body>
    <main>
        <jsp:include page="/WEB-INF/views/common/header.jsp"/>
                                        ...
                                        <%-- @PathVariable --%>         <%-- get 방식은 정보가 주소창에 --%>
        <%-- 상대경로 /board2/1/2006/update?cp=1 (GET) --%>
        <%-- 절대경로 /board2/1/2006/update (POST) --%>
        <form action="update" method="POST" class="board-write" id="boardUpdateFrm" enctype="multipart/form-data"> 
            <%--   enctype="multipart/form-data" : 제출 데이터 인코딩 X -> 파일 제출 가능 -> MultiPartResolver가 문자열, 파일을 구분  -> 문자열 -> String, int, DTO, Map (HttpMessageConverter) -> 파일 -> MultiPartFile 객체 -> transferTo() (파일을 서버에 저장) --%>
