...
public class AjaxController {
	...
	@ResponseBody
	public String selectMemberTel(String nickname) { // 쿼리 스트링에 담겨있는 파라미터
...
//		@ResponseBody 
	...
	@GetMapping(value="/dupCheck/email")
	@ResponseBody // HttpMessageConverter를 이용해 JS에서 인식할 수 있는 형태(TEXT/JSON) 변환 + 비동기 요청한 곳으로 돌아감
	...
	@ResponseBody // Java객체/데이터 -> JSON, TEXT로 변환 + 비동기 요청한 곳으로 응답
	public Member selectMember(@RequestBody Map<String, Object> paramMap) {
		//@RequestBody Map<String, Object> paramMap
		// 0-> 요청된 HTTP Body에 담긴 모든 데이터를 Map으로 반환
