...
public class Member {
	...
	//인스턴스 변수
	private String memberId = "명시적 초기화"; // 인스턴스 변수
	private String memberPw; // 인스턴스 변수
	private String memberName; // 인스턴스 변수
	private int memberAge; // 인스턴스 변수
	...
	// 클래스 초기화 블럭 - 프로그램 실행 시 static 변수를 초기화 하는 용도
	//                      (프로그램 실행 시 1회만 수행됨)
	static {
	...
	public Member() { // 기본 생성자 () 안에 아무것도 없음
		...
		// public Member(){}
		//
		// 단, 기본 생성자만 없고 다른 매개변수 생성자가 존재하면 컴파일러는
		// 자동을 기본 생성자를 추가하지 않는다.
		//
		//********************************************************
	...
	public Member(String memberId, String memberPw, String memberName, int memberAge) {
		// Member() 생성자 호출 시 ()안에 String, String, String, int 을 작성해라
		System.out.println("매개변수 생성자(String, String, String, int)로 생성");
		// 전달 받은 값을 필드에 대입
		// this. (this 참조 변수)
		// 모든 인스턴스에 숨겨져 있는 필드
		// 현재 인스턴스(객체)의 시작주소가 저장되어 있어
		// 현재 인스턴스 참조함. (가리킴)
