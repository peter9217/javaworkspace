...
// 현실에서의 객체 : 속성(data)와 기능(method)을 가지고 있는 식별 가능한 것

// 클래스 : 객체의 특성(속성, 기능) 정의한 것 (일종의 설계도)
//			-> 설계도(클래스)는 객체가 아니다!
//			-> 하나의 설계도(클래스)로 여러 객체를 만들 수 있다.
public class Nation {
	
	// 국민이라면 가지고 있어야 하는 공통된 속성(정도, 데이터)
	...
	public void medicalBenefits() {
		System.out.println("의로 혜택을 받을 수 있다.");
				
	}
	// [캡슐화] 두번째 특징(원칙) private으로 지정된 멤버변수에 대한
		// 간접 접근 방법(기능)을 작성
