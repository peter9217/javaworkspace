...
// -> 콘솔에 내용 출력, 입력 받는 용도의 객체를 만들기 위한 클래스
public class MethodExView {
	// 필드(==멤버변수)
	private Scanner sc = new Scanner(System.in);
	// 클래스 내 어디서든 사용 사능한 Scanner 객체 생성
	...
	public void  displayMenu() { // 메뉴 표시(출력) 기능
		...
		do {
			...
			System.out.println();
			switch(input) {
			case 1 : menu1(); break; // 1입력 시 menu1() 메서드 호출 
			case 2 : menu2(); break; // 2 입력 시 munu2() 호출
			case 3 : menu3(); break;
			case 4 : break;
	...
	private void menu3() {
		...
		// 2) 난수 5개가 저장된 int[]값이 반환됨(돌아옴)
		//   -> 반환된 int[]은 실제 배열이 아닌 int[]의 주소값이다.
