...
//  기본 생성자
	public UserView() {
		...
		signUpUser = new User("asd", "123", "aaaa", 'm');
	}
	...
	private void signUp() {
		...
		if(signUpUser != null) { // signUpUser 가 참조를 하고 있는 경우
			System.out.println("회원가입 성공");
		}else {
			System.out.println("비밀번호가 일치핮 안");
		}
	...
	private void login() {
		...
		// 입력 받은 값 + signUpUser를 Service의 login 메서드로 전달하여 아이디 비밀번호
		// 일치 시 로그인
