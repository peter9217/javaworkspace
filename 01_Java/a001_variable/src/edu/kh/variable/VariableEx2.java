...
public class VariableEx2 {
	...
	public static void main(String[] args) {
	   ...
	   //자료형    변수명
	    ...
	    // float : 3.14f, 0123.456f, 0.0f
	    
	    //boolaen : true, false만 가능
	    ...
	    // 다만, 정수를 저장하고 있다가 화면에 출력 시 문자표에 대응되는 문자가 
	    // 출력된다. (인코딩)
