...
public class MapService {
	...
	public void ex1() {
		 ...
		 * 
		 *  - Value만 모아서 봤을 때 List(index->key)의 특징을 지님 --> 중복 O, 
		 * 
		 * */
...
//		Map<String, Object> member = new HashMap<>();
		...
		if(member.get("memberId").equals(id)) {
			// value가 Object 타입이기 때문에 equals()는 Object의 equals() 코드와 연결 정적바인딩
			// 하지만 프로그램 수행 시 실제 참조하는 객체의 타입 String의 equals()로 연결됨 동적바인딩
