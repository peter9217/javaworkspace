...
public class SwitchEx {
	...
	public void ex1() {
		...
		// sc -> ctrl + spacebar -> Scanner 선택 -> 자동완성(문구 완성, import 추가)
...
//		 }
		 ...
		 case 2 : res = "ORANGE"; break; // 2인 경우
		 case 3 : res = "YELLOW"; break; // 2인 경우
		 case 4 : res = "GREEN"; break; // 2인 경우
		 default : res = "BLUE";		 
		 }
	...
	public void ex2() {
		...
		int random = (int)(Math.random() * 3); // 0 <= random < 3
		// 0, 1, 2 중 하나를 무작위 발생
	...
	public void ex3() {
		Scanner sc = new Scanner(System.in); // scan -> ctrl + spacebar -> enter
	...
	public void ex4() {
		...
		int num2 = sc.nextInt();
		String no = "0으로는 나눌 수 없습니다.";
		
		switch(str) {
		case "+" : System.out.printf("%d %s %d = " + (num1+num2), num1, str, num2); break;
		case "-" : System.out.printf("%d %s %d = " + (num1-num2), num1, str, num2); break;
		case "*" : System.out.printf("%d %s %d = " + (num1*num2), num1, str, num2); break;
		case "/" : if (num2==0) {
			System.out.print(no); break;
		}else {
			System.out.printf("%d %s %d = " + ((double)num1/(double)num2), num1, str, num2); break;
		}
		case  "%" : if (num2==0) {
			System.out.print(no); break;
		}else {
			System.out.printf("%d %s %d = " + (num1%num2), num1, str, num2); break;
		}
