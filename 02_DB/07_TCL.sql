...
-- 경리부 삽입 확인 (아직 DB에 실제로 삽입되지 ㅇ낳았다.)
SELECT * FROM DEPARTMENT3;

-- 롤백 ROLLBACK; >>마지막 커밋 상태로 되돌아감
ROLLBACK;
...
DELETE FROM DEPARTMENT3 WHERE DEPT_ID = 'D1';
--> DELETE 내역이 트랜잭션에 저장
...
-- D2 삭제
DELETE FROM DEPARTMENT3 WHERE DEPT_ID = 'D2';

SELECT * FROM DEPARTMENT3;

SAVEPOINT S2;

DELETE FROM DEPARTMENT3 WHERE DEPT_ID = 'D3';
SELECT * FROM DEPARTMENT3;
