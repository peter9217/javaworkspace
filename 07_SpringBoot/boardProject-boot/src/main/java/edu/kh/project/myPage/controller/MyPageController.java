...
public class MyPageController {
	...
	public String info() {
		...
		return "myPage/myPage-info";		/*"/WEB-INF/views/myPage/myPage-info.jsp";*/
	}
	...
	//회원 정보 수정
	@PostMapping("/info")
	public String updateInfo(Member updateMember, String[] memberAddress, @SessionAttribute("loginMember") Member loginMember
			, RedirectAttributes ra) {
		
		// 매개 변수 설명 =========================================
		// Member updateMember : 수정할 닉네임, 전화번호 담긴 커맨드 객체
		// Member updateMember, String[] memberAddress : name="memberAddress"인 input 3개의 값 (주소)
		// @SessionAttribute("loginMember") Member loginMember : Session에서 얻어온 "loginMember"에 해당하는 객체를 매개 변수 Member loginMember에 저장
...
//		HttpServletResponse resp 서버 -> 관리자
		...
		//  - 비밀번호가 일치핮 ㅣㅇ낳으면 -> 0 반환
		int result = service.del(memberPw, memberNo);
		String path = "redirect:";
